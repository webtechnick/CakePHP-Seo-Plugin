<div class="seo_plugin">
	...
	<div class="seoStatusCodes index">
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View', true), array('action' => 'view', $seoStatusCode['SeoStatusCode']['id'])); ?>
				<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $seoStatusCode['SeoStatusCode']['id'])); ?>
				<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $seoStatusCode['SeoStatusCode']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $seoStatusCode['SeoStatusCode']['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
		</table>
	...
	<div class="actions">
		...
		<ul>
			<li><?php echo $this->Html->link(__('New Seo Status Code', true), array('action' => 'add')); ?></li>
		</ul>
	</div>
</div>
<div class="seo_plugin">
	...
	<div class="actions">
		...
		<ul>
			...
			<li><?php echo $this->Form->postLink(__('Delete Seo Blacklist'), array('action' => 'delete', $seoBlacklist['SeoBlacklist']['id']), null, __('Are you sure you want to delete # %s?', $seoBlacklist['SeoBlacklist']['id'])); ?> </li>
		</ul>
	</div>
</div>